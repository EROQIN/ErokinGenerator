...
import com.erokin.maker.template.model.TemplateMakerOutputConfig;
...
public class TemplateMaker {
    ...
    private static Meta.FileConfig.FileInfo makeFileTemplates(TemplateMakerModelConfig templateMakerModelConfig, String sourceRootPath, File inputFile) {
        ...
        boolean isExistTemplateFile = FileUtil.exist(fileOutputAbsolutePath);
        ...
        //之前不存在模板文件，并且这次替换没有修改文件内容才是静态生成
        // 和原文件一致，没有挖坑，则为静态生成
